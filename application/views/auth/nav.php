 ...
 <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent mt-4">
    <div class="container">
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ps ps--active-x ps--active-y" id="navigation">
      ...
      <div class="ps__rail-x" style="width: 970px; left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 967px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 39px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 3px;"></div></div></div>
    </div>
  </nav>
  <!-- End Navbar -->