...
<a href="<?=base_url('user/add')?>"><button type="button" class="btn btn-primary" >
  Add Konten
</button>
</a>
</form>
        ...
        <td>
          ...
          <td>
            <div class="d-flex px-2 py-1">
              ...
              <a href="<?=base_url('user/detail/'.$aa->id_konten)?>"><button type="button" class="btn bg-gradient-warning mx-2" data-original-title="Edit " >
              Detail
            </button></a>
            <a onClick="return confirm('Apakah anda yakin ingin menghapus user ini?')" href="<?=base_url('user/delete/'.$aa->foto)?>"><button type="button" class="btn bg-gradient-danger" data-original-title="Edit " ">
              Delete
            </button></a>
              </div>
            </div>
