...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#allkategori">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="<?=base_url('user/simpan_kategori')?>">
  <div class="row">
    <div class="col-md-6">
...
<div class="modal fade" id="allkategori" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">List Semua Kategori</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <ol>
        <?php $no = 0 ?>
        <?php foreach($all_kategori as $kk){ ?>
          <li>
            <?=$kk->kategori?>
          </li>
          <?php } ?>
      ...
      <tbody>
        ...
        <td>
          ...
          <button type="button" class="btn bg-gradient-warning" data-original-title="Edit " data-bs-toggle="modal" data-bs-target="#edit<?= $user->id_kategori?>">
            ...
            <a onClick="return confirm('Apakah anda yakin ingin menghapus kategori ini?')" href="<?=base_url('user/delete_kategori/'.$user->id_kategori)?>" class="btn bg-gradient-danger" data-toggle="tooltip" data-original-title="Delete">
              Delete
            </a>
          </td>
        </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form method="post" action="<?=base_url('user/update_kategori')?>">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
